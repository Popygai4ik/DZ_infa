...
Если флаг установлен, программа выводит "1" и значение переменной i, которая содержит порядковый номер числа Фибоначчи. В противном случае, программа выводит "0".
